...
Detailed release notes for versions 0.3.0 through 0.13.0. The top-level
`CHANGELOG.md` keeps a heading plus a one-paragraph summary per archived
release; the full council-review iteration history lives here.
